var Inbox = function() {
    ...
    return {
        ...
        init: function() {
            ...
            $('.inbox-nav > li.biology > a').click(function() {
                loadInbox($(this), 'biology');
            });

            // handle sent listing
            $('.inbox-nav > li.action > a').click(function() {
                loadInbox($(this), 'action');
            });

            // handle draft listing
            $('.inbox-nav > li.function > a').click(function() {
                loadInbox($(this), 'function');
            });

            $('.inbox-nav > li.third > a').click(function() {
                loadInbox($(this), 'third');
            });
            $('.inbox-nav > li.home > a').click(function() {
                loadInbox($(this), 'home');
            });
            $('.inbox-nav > li.warn > a').click(function() {
                loadInbox($(this), 'warn');
            });
            $('.inbox-nav > li.medicine > a').click(function() {
                loadInbox($(this), 'medicine');
            });
            $('.inbox-nav > li.product > a').click(function() {
                loadInbox($(this), 'product');
            });
            ...
            if (Metronic.getURLParameter("a") === "view") {
                ...
                $('.inbox-nav > li.biology > a').click();
                //loadInbox($('.inbox-nav > li.biology > a'), 'biology');
            }
