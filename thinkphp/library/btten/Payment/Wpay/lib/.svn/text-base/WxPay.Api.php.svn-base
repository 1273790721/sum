...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		if(!$inputObj->IsNotify_urlSet()){
            $inputObj->SetNotify_url('http://localhost/zsrc/'.WxPayConfig::NOTIFY_URL);
			//$inputObj->SetNotify_url(C('SITE_URL').WxPayConfig::NOTIFY_URL);//异步通知url  C('SITE_URL') = http://localhost/zsrc/
		}
